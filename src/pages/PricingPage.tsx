          ...
          {plans.map((plan) => (
            ...
            >
              <div className="p-6">
                ...
                <p className="mt-4">
                  <span className="text-4xl font-bold text-[#B31B1B]">{plan.price}</span>
                ...
                <button
                  ...
                  className="mt-8 w-full bg-[#B31B1B] text-white py-2 px-4 rounded-md hover:bg-[#B31B1B]/90 transition-colors"
                >
                  Get Started
                </button>
              </div>
